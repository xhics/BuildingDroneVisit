...
class Orthofacade:
    ...
    def as_dict(self) -> dict:
        ...
        return {
            ...
            "by_status": counts,
            "disagreement_fraction": round(counts.get("desaccord", 0) / max(len(self.support), 1), 3),
...
def plane_from_edge(start, end, height_m, facade_id="FACADE", top_z_start_m=None, top_z_end_m=None):
