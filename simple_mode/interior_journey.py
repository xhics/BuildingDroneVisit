...
def build_ref2va_prompt(
    ...
    *,
    ...
    return (
        ...
        "retention_analysis:\n"
        f"{retention}\n"
        "Les images servent d'inspiration pour le style, les matériaux et "
        "l'ambiance des lieux traversés ; elles ne doivent pas être reproduites "
        "telles quelles ni apparaître comme des plans fixes.\n\n"
